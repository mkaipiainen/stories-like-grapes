  ...
  return {
    generateS3Url: async (id: string, type: 'GET' | 'PUT' | 'DELETE') => {
      ...
      const url = isProduction
        ? `https://stories-like-grapes.s3.eu-north-1.amazonaws.com/${id}`
        : `https://stories-like-grapes-dev.s3.eu-north-1.amazonaws.com/${id}`;
      ...
      if (accessKeyId && secretAccessKey) {
        ...
        throw new Error(
          'AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY must be defined in env',
        );
      }
    },
  };
